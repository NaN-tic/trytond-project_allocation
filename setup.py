...
setup(name='%s_%s' % (PREFIX, MODULE),
    ...
    url='https://github.com/NaN-tic/trytond-project_allocation',
    download_url='https://github.com:nantic/trytond-project_allocation.git',
    ...
    project_urls = {
       "Source Code": 'https://github.com:NaN-tic/trytond-project_allocation.git'
    },
    classifiers=[
